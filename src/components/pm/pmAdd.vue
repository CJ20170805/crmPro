        ...
        <el-form :model="pmForm" :rules="rules" ref="pmForm" label-width="100px">
            ...
            <el-form-item label="签单人员"  required>
                <el-col :span="9">
                    <!-- <el-input v-model="ruleForm.name"></el-input> -->
                     <el-select v-model="pmForm.reachMan" filterable placeholder="请选择">
                        <el-option
          ...
          <el-form-item label="服务时间" required>
           ...
           <div class="form-title">
            ...
            <el-form-item label="付款账户" required prop="payId">
                <el-col :span="12">
            ...
            <el-form-item>
                <el-button type="primary" @click="submitForm('pmForm')">立即创建</el-button>
            </el-form-item>
        </el-form>
      </div>
    </div>
      ...
      handleRemove (file, fileList) {
        ...
        this.pmForm.uploadImgs.forEach((v, k) => {
          if (v.indexOf(fileName) === -1) {
             this.uploadImgsNew.push(v)
          }
        })
        this.pmForm.uploadImgs = this.uploadImgsNew
